...
This is a placeholder for consolidated documentation. Use START_HERE.md and MODELS.md for near-term plans.
...
```typescript
// sophia-intel-app/src/components/dashboard/CostDashboard.tsx
...
- **Dual Orchestrators**: Sophia (BI) and Sophia (Coding)
...
class WebResearchTeam:
    ...
    def __init__(self, domain: str):
        self.domain = domain  # "sophia" or "sophia"
...
While maintaining strict boundaries, create a "wisdom layer" where insights from Sophia (business) inform Sophia (technical) priorities. For example, declining sales metrics could trigger Sophia to prioritize performance optimizations.
...
# Sophia + Sophia Implementation Summary
...
- **Permission Granularity**: Domain-level (Sophia/Sophia) and service-level controls
...
- **Universal AI Orchestrator**: Single chat interface for Sophia + Sophia
