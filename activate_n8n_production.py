...
import httpx
import os
# n8n Cloud Configuration (read from environment)
N8N_API_KEY = os.getenv("N8N_API_KEY", "")
N8N_INSTANCE_URL = os.getenv("N8N_INSTANCE_URL", "")
WEBHOOK_URL = os.getenv("N8N_GONG_WEBHOOK_URL", "")
class N8NProductionActivator:
    """Handles production activation of n8n workflows"""
    def __init__(self):
        if not N8N_API_KEY or not N8N_INSTANCE_URL:
            raise RuntimeError("N8N_API_KEY and N8N_INSTANCE_URL must be set in environment")
