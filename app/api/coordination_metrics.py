...
async def get_metrics_dashboard() -> MetricsSummary:
    ...
    try:
        ...
        _metrics = {
            "active_tasks": allocator.budgets.get("", {}).get("active_tasks", 0),
            "tokens_used": allocator.budgets.get("", {}).get("tokens_used", 0),
        ...
        costs = {
            ...
            "_usd": allocator.budgets.get("", {}).get(
                "budget_spent", 0.0
            ),
