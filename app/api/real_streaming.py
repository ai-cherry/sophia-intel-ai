...
async def stream_coding_swarm_execution(
    ...
    try:
        ...
        yield json.dumps({
            ...
            'planning_result': planning_result['content'][:500] + '...' if planning_result['success'] else 'Planning failed',
            'timestamp': datetime.now().isoformat()
        }) + '\n'
        await asyncio.sleep(0.3)
        ...
        generation_result = await real_executor.execute(
            ...
            context={
                ...
                'memory_results': memories_context,
                'planning_context': planning_result['content'] if planning_result['success'] else None
            }
        )
        ...
        yield json.dumps({
            ...
            'generation_result': generation_result['content'][:500] + '...' if generation_result['success'] else 'Generation failed',
            'timestamp': datetime.now().isoformat()
        }) + '\n'
        await asyncio.sleep(0.3)
        ...
        yield json.dumps({
            ...
            'critic_result': critic_result['content'][:300] + '...' if critic_result['success'] else 'Review failed',
            'timestamp': datetime.now().isoformat()
        }) + '\n'
        await asyncio.sleep(0.3)
        ...
        judge_result = await real_executor.execute(
            ...
            context={
                ...
                'original_task': request.message,
                'generation_result': generation_result['content'][:500] if generation_result['success'] else None
            }
        )
        ...
        yield json.dumps({
            ...
            'judge_result': judge_result['content'][:300] + '...' if judge_result['success'] else 'Decision failed',
            'timestamp': datetime.now().isoformat()
        }) + '\n'
        await asyncio.sleep(0.3)
        ...
        yield json.dumps({
            ...
            'final_results': {
                ...
                'generation': generation_result['content'] if generation_result['success'] else None,
