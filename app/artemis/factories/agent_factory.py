...
# Shared base types moved to base_factory
...
## TechnicalAgentRole moved to base_factory


## DomainTeamType moved to base_factory


## TechnicalPersonality moved to base_factory


## ArtemisAgentTemplate moved to base_factory
