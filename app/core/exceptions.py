...
class ReasoningError(SophiaBaseException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(message=message, category=ErrorCategory.REASONING, **kwargs)
...
class ModelError(SophiaBaseException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(message=message, category=ErrorCategory.MODEL, **kwargs)
...
class SecretExposureError(SecurityError):
    ...
    def __init__(self, **kwargs):
        super().__init__(message="Potential secret exposure detected", **kwargs)
...
class GuardrailError(SophiaBaseException):
    ...
    def __init__(self, violation: GuardrailViolation, **kwargs):
        super().__init__(
...
class ErrorHandler:
    ...
    def report_guardrail_violation(
        self, violation: GuardrailViolation, raise_error: bool = True
