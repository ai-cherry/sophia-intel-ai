    ...
    def _initialize_approvals(self) -> dict[str, ModelApproval]:
        ...
        default_approvals = {
            ...
            "gpt-5": ModelApproval(
                ...
                allowed_orchestrators={"artemis", "sophia", "master"},
                allowed_agents=set(),
                cost_tier="premium",
            ...
            "grok-4-heavy": ModelApproval(
                ...
                status=ApprovalStatus.RESTRICTED,
                allowed_orchestrators={"master", "artemis", "sophia"},
            ...
            "grok-4": ModelApproval(
                ...
                allowed_orchestrators={"artemis", "sophia"},
