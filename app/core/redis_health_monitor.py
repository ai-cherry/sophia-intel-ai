...
class RedisHealthMonitor:
    ...
    def __init__(self, redis_manager: Optional[RedisManager] = None):
        # Lazy import to avoid circulars and ensure a usable default
        try:
            from app.core.redis_manager import (
                redis_manager as _global_redis_manager,  # type: ignore
            )
        except Exception:
            _global_redis_manager = None  # type: ignore
        self.redis_manager = redis_manager or _global_redis_manager
    ...
    async def _check_streams_health(self) -> dict[str, Any]:
        ...
        try:
            ...
            stream_patterns = ["swarm:*", "pay_ready:*", "sophia:*", ":*"]
            async with self.redis_manager.get_connection() as redis:
