...
class SecureWebSocketFactory:
    ...
    @staticmethod
    async def create__tactical_manager() -> WebSocketManager:
        """Create WebSocket manager for  tactical operations"""
        from .websocket_security_config import _TACTICAL_CONFIG
        return await SecureWebSocketFactory.create_manager(_TACTICAL_CONFIG)
    @staticmethod
