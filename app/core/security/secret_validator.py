...
class ComprehensiveSecretValidator:
    ...
    def identify_secret_type(self, key: str, value: str) -> SecretType:
        ...
        if "openai" in key_lower:
            ...
            # No direct Google key type; treat as OpenRouter key or generic token
            return SecretType.OPENROUTER_API_KEY
        ...
        if value.startswith("sk-"):
            ...
            # Treat Google-style key as unsupported direct; mark as invalid format under generic token
            return SecretType.JWT_TOKEN
