...
class InfraOpsSwarm:
    ...
    async def _execute_with_agents(
        self, task: InfraTask, agent_names: list[str]
    ) -> list[dict[str, Any]]:
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        results = await self._execute_with_agents(health_task, list(self.agents.keys()))
...
if __name__ == "__main__":
    async def test_infraops_swarm():
        ...
        security_task = {
            ...
            "context": {"scope": "all", "severity_threshold": "medium"},
            "require_approval": False,
        }
