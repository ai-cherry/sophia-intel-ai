...
from app.weaviate.weaviate_client import VectorSearchResult, WeaviateClient
...
class GongRAGService:
    ...
    async def semantic_search(
        ...
        for collection_key in collections:
            ...
            try:
                # Build filters
                self._build_where_filter(filters, date_range)
    ...
    def _convert_to_search_result(
        self, vector_result: VectorSearchResult, collection_key: str
    ) -> Optional[SearchResult]:
        """Convert Weaviate result to SearchResult with proper citation"""
