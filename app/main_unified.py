...
class SophiaAIUnified:
    ...
    def _setup_middleware(self):
        ...
        # CORS middleware
        allowed_origins = os.getenv('CORS_ORIGINS', '${SOPHIA_FRONTEND_ENDPOINT},http://localhost:5173').split(',')
    ...
    async def initialize(self):
        ...
        try:
            ...
            setup_telemetry(
                service_name="sophia-ai-unified",
            ...
            try:
                ...
                if self.factory_swarm:
                    ...
                    health_status["components"]["factory_swarm"] = {
                        ...
                        "cache_size": len(self.factory_swarm.cache.l0_cache) if self.factory_swarm.cache else 0
                    }
            ...
            return {
                "agents": [
                    ...
                    },
                    {
                        ...
                        "capabilities": ["ticket_analysis", "satisfaction_tracking", "support_coaching"]
                    },
                    {
                        "id": "client_health",
                    ...
                    },
                    {
                        ...
                        "capabilities": ["strategic_analysis", "executive_reporting", "risk_management"]
                    }
                ]
            }
    ...
    async def _handle_product_strategist(self, message: str, context: Dict) -> Dict:
        ...
        if self.factory_swarm:
            return await self.factory_swarm._proxy_fallback(
                {"query": message, "type": "product_strategy"}, 
                context
            )
        else:
    ...
    async def _handle_intelligent_routing(self, message: str, context: Dict) -> Dict:
        ...
        elif any(word in message_lower for word in ['support', 'ticket', 'customer', 'satisfaction']):
        ...
        elif any(word in message_lower for word in ['product', 'feature', 'roadmap', 'development']):
