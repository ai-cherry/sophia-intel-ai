...
class MCPServerRegistry:
    ...
    def _initialize_registry(self):
        ...
        self._setup_core_allocations()
        self._setup_sophia_allocations()
        self._setup_shared_allocations()
        # Initialize partitioning strategies
        self._initialize_partitions()
    def _setup_core_allocations(self):
        """Setup core domain server allocations"""
        # Exclusive core servers
        self.allocations[MemoryDomain.CODE].extend(
            [
                ServerAllocation(
                    server_name="_filesystem",
        ...
        # Shared servers with core-specific configurations
        self.allocations[MemoryDomain.CODE].extend(
            [
                ServerAllocation(
