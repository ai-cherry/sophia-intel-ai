"""
MCP Router Configuration for Sophia Platform
...
class MCPServerType(Enum):
    ...
    # Technical Domain (internal technical domain)
...
class MCPRouterConfiguration:
    ...
    def _initialize_routing_rules(self):
        ...
        self.routing_rules[MCPServerType.FILESYSTEM] = RoutingRule(
            ...
            allowed_domains={MemoryDomain.CODE},
            priority=1,
        ...
        self.routing_rules[MCPServerType.DATABASE] = RoutingRule(
            ...
            allowed_domains={MemoryDomain.CODE, MemoryDomain.SOPHIA},
            priority=1,
            filters={
                "": {
        ...
        self.routing_rules[MCPServerType.META_TAGGING] = RoutingRule(
            ...
            filters={
                "tag_domains": {
                    "": ["code", "architecture", "security", "performance"],
        ...
        self.routing_rules[MCPServerType.CHUNKING] = RoutingRule(
            ...
            filters={
                "strategies": {
                    "": "ast_based",  # Abstract Syntax Tree based for code
    ...
    def _initialize_server_configs(self):
        ...
        #  Technical Servers
        self.server_configs["_filesystem"] = MCPServerConfig(
            name="_filesystem",
            server_type=MCPServerType.FILESYSTEM,
            ...
            metadata={"domain": "", "priority": "high"},
        )
        self.server_configs["_code_analysis"] = MCPServerConfig(
            name="_code_analysis",
            server_type=MCPServerType.CODE_ANALYSIS,
            ...
            metadata={"domain": "", "compute_intensive": True},
        )
        self.server_configs["_design"] = MCPServerConfig(
            name="_design",
            server_type=MCPServerType.DESIGN_SERVER,
