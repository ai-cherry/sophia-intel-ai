...
class ProjectMemory:
    ...
    def add_known_issue(self, issue_id: str, description: str, 
                       solution: Optional[str] = None, tags: List[str] = None):
...
class GlobalMemory:
    ...
    def record_pattern_usage(self, pattern_name: str, context: Dict, success: bool):
        ...
        self.design_patterns[pattern_name]["contexts"] = \
            self.design_patterns[pattern_name]["contexts"][-20:]
