...
try:
    from app.orchestrators.persona_system import (
        PersonaContext,
        PersonaResponse,
        SophiaPersonaSystem,
    )
...
class PersonaManager:
    ...
    async def get_team_members(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "team_members": team_members, "total": len(team_members)}
        except Exception as e:
            logger.error(f"Error getting team members: {e}")
            return {"success": False, "error": str(e), "team_members": [], "total": 0}

    async def chat_with_persona(
        self, persona_id: str, message: str, context: Optional[dict] = None
    ) -> ChatResponse:
    ...
    async def _chat_with_agent_persona(
        self, persona_id: str, message: str, context: Optional[dict] = None
    ) -> ChatResponse:
    ...
    async def _chat_with_sophia_persona(
        self, persona_id: str, message: str, context: Optional[dict] = None
    ) -> ChatResponse:
    ...
    async def get_persona_health(self) -> dict[str, Any]:
        ...
        try:
            health_status = {"success": True, "status": "healthy", "personas": {}}
            ...
            return {"success": False, "status": "error", "error": str(e), "personas": {}}
