...
class PromptTemplates:
    """ (Technical Excellence) agent prompts"""
    @staticmethod
    def get_architect_prompts() -> dict[str, PromptTemplate]:
        ...
        return {
            "system_architecture": PromptTemplate(
                ...
                base_prompt="""As  Technical Architect, I design systems that stand the test of time and scale.
...
class MythologyPromptManager:
    ...
    def _initialize_mythology_prompts(self):
        ...
        # Initialize  technical prompts
        _agents = {
            "architect": PromptTemplates.get_architect_prompts(),
            # Additional technical agents would be added here
        }
        for agent_name, prompts in _agents.items():
            self._register_agent_prompts(agent_name, prompts, "")
