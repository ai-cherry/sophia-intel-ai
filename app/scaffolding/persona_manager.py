...
- : Code generation and technical implementation persona
...
class PersonaManager:
    ...
    def _initialize_default_personas(self) -> None:
        """Initialize Sophia and  personas"""
...
Task: {task}""",
        ...
        # Code Generation Persona (technical)
        code_gen_persona = Persona(
            name="code_gen",
            ...
            prompt_template="""You are , an expert software architect and code generation specialist.
Your role is to:
...
- Consider edge cases and error handling""",
            system_message="""You are , an advanced code generation and software architecture system. You excel at creating robust, scalable, and maintainable code solutions. You follow best practices, design patterns, and ensure high code quality with comprehensive testing and documentation.""",
            temperature=0.5,
            max_tokens=8000,
        )
        # Context adaptations for code generation persona
        code_gen_persona.context_adaptations = {
            "api_development": {
                "add_traits": ["detailed", "cautious"],
                "temperature": 0.4,
            },
        ...
        self.personas["code"] = code_gen_persona
        logger.info("Initialized default personas: Sophia and Code")
