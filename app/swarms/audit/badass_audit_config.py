...
BADASS_AGENTS = {
    ...
    "chief_architect": AgentSpec(
        ...
        specialization=["system_architecture", "technical_strategy", "scalability", "design_patterns"],
    ...
    "security_commander": AgentSpec(
        ...
        specialization=["threat_modeling", "vulnerability_assessment", "compliance", "cryptography"],
    ...
    "performance_guru": AgentSpec(
        ...
        specialization=["performance_profiling", "optimization", "scalability", "resource_management"],
    ...
    "quality_overlord": AgentSpec(
        ...
        specialization=["code_quality", "best_practices", "maintainability", "technical_debt"],
    ...
    "deepcode_analyzer": AgentSpec(
        ...
        specialization=["static_analysis", "code_complexity", "dependency_analysis", "refactoring"],
    ...
    "vulnerability_hunter": AgentSpec(
        ...
        specialization=["cve_analysis", "dependency_scanning", "code_injection", "data_leaks"],
    ...
    "integration_master": AgentSpec(
        ...
        specialization=["api_testing", "contract_testing", "e2e_testing", "data_validation"],
    ...
    "test_commander": AgentSpec(
        ...
        specialization=["test_coverage", "test_automation", "qa_processes", "regression_testing"],
    ...
    "infrastructure_expert": AgentSpec(
        ...
        specialization=["cloud_architecture", "containerization", "ci_cd", "monitoring"],
    ...
    "deployment_specialist": AgentSpec(
        ...
        specialization=["deployment_pipelines", "rollback_strategies", "blue_green", "canary_deployments"],
    ...
    "consensus_builder": AgentSpec(
        ...
        specialization=["conflict_resolution", "decision_synthesis", "stakeholder_alignment"],
    ...
    "debate_moderator": AgentSpec(
        ...
        specialization=["argumentation_analysis", "evidence_evaluation", "bias_detection"],
        confidence_threshold=0.85,
        collaboration_style="collaborator",
    ...
    "rapid_scanner": AgentSpec(
        ...
        specialization=["issue_detection", "quick_scans", "triage", "priority_assessment"],
    ...
    "pattern_detector": AgentSpec(
        ...
        specialization=["anti_patterns", "code_smells", "architectural_patterns", "design_violations"],
    ...
    "compliance_officer": AgentSpec(
        ...
        specialization=["regulatory_compliance", "standards_adherence", "audit_trails", "documentation"],
        confidence_threshold=0.90,
        collaboration_style="specialist",
        debate_tendency=0.4,
        consensus_weight=1.2
    ...
    "final_validator": AgentSpec(
        ...
        specialization=["report_synthesis", "executive_summary", "recommendation_prioritization"],
        confidence_threshold=0.88,
        collaboration_style="leader",
        debate_tendency=0.2,
        consensus_weight=1.4
...
AUDIT_FORMATIONS = {
    ...
    "strategic_planning_enhanced": {
        ...
        "agents": ["strategic_commander", "environmental_scanner", "scenario_modeler", "trend_analyst", 
                  "predictive_planner", "adaptation_agent", "chief_architect", "security_commander",
                  "performance_guru", "quality_overlord", "consensus_builder", "final_validator"],
        "phases": ["strategic_observe", "strategic_orient", "strategic_decide", "strategic_act", 
                  "discovery", "analysis", "adaptation", "consensus", "validation"],
        "parallel_teams": 5,
    ...
    "security_focused": {
        ...
        "agents": ["security_commander", "vulnerability_hunter", "compliance_officer", 
                  "infrastructure_expert", "deployment_specialist", "consensus_builder"],
        "phases": ["security_discovery", "threat_analysis", "vulnerability_assessment", "compliance_check"],
        "parallel_teams": 2,
    ...
    "architecture_deep_dive": {
        ...
        "agents": ["chief_architect", "deepcode_analyzer", "performance_guru", 
                  "pattern_detector", "quality_overlord", "debate_moderator"],
        "phases": ["architecture_analysis", "design_review", "performance_assessment", "refactoring_plan"],
        "parallel_teams": 3,
    ...
    "performance_optimization": {
        ...
        "agents": ["performance_guru", "deepcode_analyzer", "infrastructure_expert",
                  "pattern_detector", "test_commander", "consensus_builder"], 
        "phases": ["performance_profiling", "bottleneck_analysis", "optimization_opportunities"],
        "parallel_teams": 2,
    ...
    "rapid_assessment": {
        ...
        "agents": ["rapid_scanner", "pattern_detector", "vulnerability_hunter",
                  "quality_overlord", "final_validator"],
...
COLLABORATION_PATTERNS = {
    "debate_intensive": {
        ...
        "suitable_for": ["architecture_decisions", "security_assessments", "major_refactoring"]
    },
    ...
    "consensus_building": {
        ...
        "suitable_for": ["priority_ranking", "recommendation_synthesis", "final_reports"]
    },
    ...
    "expert_review": {
        ...
        "suitable_for": ["technical_deep_dives", "specialized_analysis", "compliance_review"]
    },
