...
RESEARCH_ENHANCED_FORMATIONS = {
    ...
    "security_research_audit": {
        ...
        "agents": [
            "security_researcher",
            "hf_research_specialist",
            "literature_analyst",
            "benchmark_specialist",
            "validation_agent",
        ],
        "research_phases": [
            "security_literature_review",
    ...
    "performance_research_optimization": {
        ...
        "research_phases": [
            "performance_literature_review",
            "benchmark_analysis",
            "optimization_techniques_research",
            "tool_evaluation",
        ],
...
def get_research_formation_config(formation_name: str) -> dict[str, Any]:
    ...
    return RESEARCH_ENHANCED_FORMATIONS.get(
        formation_name, RESEARCH_ENHANCED_FORMATIONS["full_research_spectrum"]
    )
