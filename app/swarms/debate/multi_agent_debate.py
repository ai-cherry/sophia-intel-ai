...
from ..communication.message_bus import MessageBus, SwarmMessage, MessageType
from ..memory.unified_memory import UnifiedMemoryStore
from ...observability.prometheus_metrics import (
    observe_debate_round, observe_consensus_reached, observe_agent_vote
)
...
class MultiAgentDebateSystem:
    ...
    def __init__(
        ...
        logger.info(f"🗣️ MultiAgentDebateSystem initialized - enhanced with MCP integration")
