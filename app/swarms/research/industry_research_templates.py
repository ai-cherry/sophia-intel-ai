...
def get_template_by_id(template_id: str) -> Optional[ResearchTemplate]:
...
def get_recommended_template(industry: str, depth: str = "standard") -> Optional[ResearchTemplate]:
...
class TemplateOrchestrator:
    ...
    def create_custom_template(self, base_template_id: str, 
                             customizations: Dict[str, Any]) -> ResearchTemplate:
        ...
        custom_template = ResearchTemplate(
            ...
            premium_models_required=customizations.get("premium_models", base.premium_models_required),
            ...
            stakeholder_notifications=customizations.get("notifications", base.stakeholder_notifications)
        )
