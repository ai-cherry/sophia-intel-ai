    ...
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col space-y-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
              ...
              <div className="space-y-3">
                {searchResults.length === 0 && !isSearching && (
                  <div className="text-center text-muted-foreground py-8">
                    ...
                    <p className="text-sm">Use "Deep Research" for comprehensive analysis</p>
                  </div>
                )}
                    ...
                    <div className="space-y-2">
                      ...
                      {result.scraped_content && (
                        <div className="mt-2 p-2 bg-gray-50 rounded text-xs">
                          ...
                          <p className="line-clamp-4">{result.scraped_content}</p>
                        </div>
                      )}
                      ...
                      <div className="flex items-center space-x-2 pt-2">
                        ...
                        {onSendToChat && (
                          <Button
                            ...
                            size="sm"
                            onClick={() => sendToChat(
                              result.scraped_content || result.snippet || result.url,
                              result.title
                            )}
                            className="flex items-center space-x-1"
                          >
          ...
          {/* Scrape Tab */}
          <TabsContent value="scrape" className="flex-1 flex flex-col space-y-4">
            <div className="space-y-2">
              <div className="flex space-x-2">
                <Input
                  value={scrapeUrl}
            ...
            <ScrollArea className="flex-1">
              {!scrapeResult && !isScraping && (
                <div className="text-center text-muted-foreground py-8">
                  ...
                  <p className="text-sm">Supports JavaScript-heavy sites and anti-bot protection</p>
                </div>
              )}
                ...
                <Card className="p-4">
                  <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => copyToClipboard(scrapeResult.content)}
                            >
                            ...
                            {onSendToChat && (
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={() => sendToChat(scrapeResult.content, scrapeResult.title)}
                              >
                    ...
                    {scrapeResult.links && scrapeResult.links.length > 0 && (
                      <div className="space-y-2">
                        <p className="font-medium text-sm">Extracted Links ({scrapeResult.links.length}):</p>
                        <div className="max-h-32 overflow-y-auto space-y-1">
                          ...
                          {scrapeResult.links.length > 10 && (
                            <p className="text-xs text-muted-foreground">
                              ... and {scrapeResult.links.length - 10} more links
                            </p>
                          )}
                        </div>
                      </div>
