...
from backend.notion_service import NotionService, NotionSearchRequest, NotionCreatePageRequest
        ...
        async def research(request: ResearchRequest):
            ...
            try:
                ...
                if request.strategy == "serp":
                    ...
                    search_results = await self.web_access.search(
                        query=request.query,
                        max_results=5,
                        strategy="auto"
                    )
        ...
        async def web_summarize(request: SummarizeRequest):
            ...
            try:
                ...
                return {
                    ...
                    "compression_ratio": len(response.get("content", "")) / len(request.content) if request.content else 0
                }
