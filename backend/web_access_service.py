...
class WebAccessService:
    ...
    async def _brightdata_scrape(self, url: str, extract_text: bool, extract_links: bool, extract_images: bool) -> Dict[str, Any]:
    ...
    async def _zenrows_scrape(self, url: str, extract_text: bool, extract_links: bool, extract_images: bool) -> Dict[str, Any]:
        ...
        try:
            async with httpx.AsyncClient(timeout=60.0) as client:
                ...
                if extract_text:
                    params["css_extractor"] = json.dumps({
                        "title": "title",
                        "content": "body"
                    })
    ...
    async def _apify_scrape(self, url: str, extract_text: bool, extract_links: bool, extract_images: bool) -> Dict[str, Any]:
