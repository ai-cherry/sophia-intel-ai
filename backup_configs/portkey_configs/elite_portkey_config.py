...
class EliteOptimizations:
    ...
    # Batching strategies
    BATCH_STRATEGIES = {
        "heavy_models": {"batch_size": 5, "timeout_ms": 60000, "parallel_requests": 2},
        "balanced_models": {"batch_size": 10, "timeout_ms": 30000, "parallel_requests": 5},
        "fast_models": {"batch_size": 20, "timeout_ms": 10000, "parallel_requests": 10},
    }
    ...
    def get_model_tier(model: str) -> str:
        ...
        expensive = [
            EliteModels.DEEPSEEK_V31,
            EliteModels.GEMINI_25_PRO,
            EliteModels.QWEN3_CODER_480B,
        ]
        cheap = [
            EliteModels.GEMINI_25_FLASH_LITE,
            EliteModels.DEEPSEEK_V3_0324_FREE,
            EliteModels.GPT_4O_MINI,
        ]
        ...
        **kwargs,
        ...
        headers = {
            ...
            "x-portkey-retry": json.dumps(
                {"attempts": 3, "on_status_codes": [429, 500, 502, 503, 504]}
            ),
        }
