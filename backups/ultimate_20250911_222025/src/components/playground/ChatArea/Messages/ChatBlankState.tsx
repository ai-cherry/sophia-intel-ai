    ...
    >
      <div className="flex max-w-3xl flex-col gap-y-8">
        ...
        >
          <div className="flex items-center justify-center gap-x-2 whitespace-nowrap font-medium">
            ...
            <span className="inline-flex translate-y-[10px] scale-125 items-center transition-transform duration-200 hover:rotate-6">
              ...
              >
                <span className="text-blue-500 font-bold">SOPHIA</span>
              </Link>
            </span>
            <span className="flex items-center font-[600]">
          ...
          <p>Your unified business intelligence dashboard for PayReady.</p>
        </motion.h1>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          />
          <ActionButton
            href={EXTERNAL_LINKS.sophia}
            text="SOPHIA INTEL HOME"
          />
        </motion.div>
      </div>
    </section>
