...
import IntegrationQuickActions from '@/components/sophia/IntegrationQuickActions';
import SlackTeamActivity from '@/components/sophia/SlackTeamActivity';
    ...
    <div className="flex h-[calc(100vh-0px)]">
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6 space-y-6">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-4">
          ...
          <Section title="Slack Activity" subtitle="Active users and channels">
            <SlackTeamActivity />
          </Section>
        </div>
