...
interface SwarmTemplate {
  ...
  domain: 'sophia_business' | 'sophia_technical' | 'pay_ready' | 'cross_domain';
  category: string;
...
const SwarmTemplateSelector: React.FC = () => {
  ...
  const getDomainColor = (domain: string) => {
    switch (domain) {
      ...
      case 'sophia_technical': return 'secondary';
          ...
          <Grid item xs={12} sm={6} md={2}>
            <FormControl fullWidth size="small">
              ...
              >
                ...
                <MenuItem value="sophia_technical">Sophia Technical</MenuItem>
      ...
      {templateSummary && (
        <Paper sx={{ p: 2, mt: 3 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={3}>
              <Typography variant="body2">
                <strong>Sophia Technical:</strong> {templateSummary.by_domain?.sophia_technical || 0}
              </Typography>
            </Grid>
          </Grid>
        </Paper>
