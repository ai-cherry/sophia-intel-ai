#!/usr/bin/env python3
"""
Create domain separation configuration files for Sophia and 
"""
import json
import os
...
def create_domain_separation_config():
    ...
    #  config - CEO-only technical dashboard
    _config = {
        "domain": "",
    ...
    # Save configs
    with open(config_dir / ".json", "w") as f:
