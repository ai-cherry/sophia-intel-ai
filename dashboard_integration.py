        ...
        <body>
            ...
            <div class="dashboard-list">
                ...
                <div class="dashboard-card">
                    ...
                    <a href="/redirect/" class="dashboard-link">Open</a>
                </div>
                <div class="dashboard-card">
...
async def health_check():
    ...
    async with aiohttp.ClientSession(timeout=aiohttp.ClientTimeout(total=2)) as session:
        ...
        # Check  API
        try:
            async with session.get(f"{API_URLS['']}/status") as response:
                if response.status == 200:
                    components["_api"] = "healthy"
                else:
                    components["_api"] = "degraded"
        except:
            components["_api"] = "unhealthy"
        # Check dashboards
...
async def unified_dashboard_data():
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            data["components"][""] = {"status": "error", "error": str(e)}
    # Cache the data
