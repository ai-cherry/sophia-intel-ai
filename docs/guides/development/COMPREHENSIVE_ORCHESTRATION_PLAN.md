...
Response: 1. Activate circuit breaker (30s)
...
Response: 1. Rebalance swarm agents (1min)
...
Response: 1. Activate API rotation (immediate)
...
Response: 1. DNS failover to LAX region (2min)
