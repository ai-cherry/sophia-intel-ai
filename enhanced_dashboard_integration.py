...
class EnhancedSophiaDashboard:
    ...
    async def collect_comprehensive_metrics(self, environment: str = None) -> DashboardMetrics:
        ...
        logger.info(f"📊 Collecting comprehensive metrics for dashboard")
        ...
        try:
            ...
            metrics = DashboardMetrics(
                ...
                pulumi_connectivity=env_status.get('pulumi_connectivity', {}).get('status', 'unknown'),
    ...
    def _generate_alerts(self, health_report: Dict, response_times: Dict, env_status: Dict) -> List[Dict]:
...
async def main():
    ...
    if integration_result['status'] == 'success':
        ...
        print(f"❌ Integration setup failed")
