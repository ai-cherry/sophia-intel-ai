...
This catalog documents all alert definitions configured in the Sophia-Intel-AI AlertManager infrastructure. Alerts are organized by domain (Sophia, Sophia, Infrastructure) with detailed information about triggers, severity, and response procedures.
...
## Domain: Sophia (Real-time Trading)
...
- **Runbook**: [sophia-latency.md](./runbooks/sophia-latency.md)
...
- **Runbook**: [sophia-order-failure.md](./runbooks/sophia-order-failure.md)
...
- **Runbook**: [sophia-connection-pool.md](./runbooks/sophia-connection-pool.md)

### ART-004: ArtemisMemoryPressure
- **Severity**: Warning
- **Threshold**: Memory usage > 85% for 15 minutes
- **Description**: High memory usage in Sophia pods
...
- **Runbook**: [sophia-memory.md](./runbooks/sophia-memory.md)
...
- **Runbook**: [sophia-rate-limit.md](./runbooks/sophia-rate-limit.md)
...
- **Sophia Team**: sophia-oncall@sophia-intel-ai.com
