...
*Runbook:* <https://docs.sophia-sophia.ai/runbooks/{{ .GroupLabels.alertname }}|View Runbook>
*Dashboard:* <https://grafana.sophia-sophia.ai/d/{{ .GroupLabels.domain }}|View Dashboard>
...
<body>
    ...
    <div class="content">
        ...
        <hr>
        <p>
            <a href="https://alertmanager.sophia-sophia.ai">AlertManager</a> |
            <a href="https://grafana.sophia-sophia.ai/d/{{ .GroupLabels.domain }}">Dashboard</a> |
            <a href="https://docs.sophia-sophia.ai/runbooks/{{ .GroupLabels.alertname }}">Runbook</a>
        </p>
    </div>
</body>
</html>
...
```json
{
  ...
  "images": [
    {
      "src": "https://grafana.sophia-sophia.ai/render/d/{{ .GroupLabels.domain }}/graph.png",
      "alt": "Metric Graph"
    }
  ]
}
...
authentication:
  ...
  oauth2:
    ...
    redirect_url: https://alertmanager.sophia-sophia.ai/oauth2/callback
...
test_scenarios:
  functional_tests:
    ...
    - name: "Severity Routing Test"
      ...
      steps:
        - Send CRITICAL alert for Sophia
    ...
    def create_test_alert(self, index):
        return {
            "labels": {
                ...
                "domain": ["sophia", "sophia", "infrastructure"][index % 3],
