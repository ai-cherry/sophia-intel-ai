    ...
    async def create_core_tables(self):
        ...
        tables = [
            ...
            CREATE TABLE IF NOT EXISTS sophia_core.agents (
                ...
                platform VARCHAR(20) NOT NULL CHECK (platform IN ('', 'sophia', 'shared')),
            ...
            # Development metrics ()
            """
            CREATE TABLE IF NOT EXISTS _dev.code_metrics (
                id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
            ...
            CREATE INDEX IF NOT EXISTS idx_code_metrics_repo ON _dev.code_metrics(repository);
            CREATE INDEX IF NOT EXISTS idx_code_metrics_type ON _dev.code_metrics(metric_type);
            """,
