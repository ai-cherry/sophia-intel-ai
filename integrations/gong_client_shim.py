...
See docs/mcp_migration.md for migration timeline.
"""
...
class GongClient:
    ...
    def get_call_transcript(self, call_id: str):
        """
        ...
        result = self._run_async(self._mcp_client.get_call_transcript(call_id))
        return result.dict() if hasattr(result, 'dict') else result

    def get_call_insights(self, call_id: str):
        """
        ...
        return [insight.dict() if hasattr(insight, 'dict') else insight for insight in insights]

    def get_call_summary(self, call_id: str):
        """
        ...
        result = self._run_async(self._mcp_client.get_call_summary(call_id))
        return result.dict() if hasattr(result, 'dict') else result

    def search_calls(self, query: str, limit: int = 10):
        """
    ...
    def close(self):
        ...
        logger.warning(
            "Using deprecated close method. Update to MCP client."
        )
        self._run_async(self._mcp_client.close())
