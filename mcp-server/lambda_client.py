...
class LambdaLabsClient:
    ...
    def start_instance(self, instance_id: str) -> Dict[str, Any]:
        ...
        try:
            resp = requests.post(f"{self.base_url}/instances/{instance_id}/start", headers=self.headers, timeout=30)
            resp.raise_for_status()
    ...
    def stop_instance(self, instance_id: str) -> Dict[str, Any]:
        ...
        try:
            resp = requests.post(f"{self.base_url}/instances/{instance_id}/stop", headers=self.headers, timeout=30)
            resp.raise_for_status()
    ...
    def restart_instance(self, instance_id: str) -> Dict[str, Any]:
        ...
        try:
            resp = requests.post(f"{self.base_url}/instances/{instance_id}/restart", headers=self.headers, timeout=30)
            resp.raise_for_status()
    ...
    def rename_instance(self, instance_id: str, new_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            resp = requests.put(
                f"{self.base_url}/instances/{instance_id}", json=payload, headers=self.headers, timeout=10
            )
            resp.raise_for_status()
