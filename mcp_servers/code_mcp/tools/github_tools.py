...
class GitHubTools:
    ...
    async def read_multiple_files(self, repository: str, file_paths: List[str], 
                                 branch: str = None) -> Dict[str, Dict]:
    ...
    async def commit_file_change(self, repository: str, file_path: str, content: str,
                                commit_message: str, branch: str, author_name: str = None,
                                author_email: str = None) -> Dict:
