...
class TestMemoryService:
    ...
    async def store_context(self, session_id: str, content: str, 
    ...
    async def query_context(self, session_id: str, query: str, 
                          top_k: int = 5, global_search: bool = False,
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            total_size = sum(
                sum(len(ctx["content"]) for ctx in contexts)
                for contexts in self.storage.values()
            )
