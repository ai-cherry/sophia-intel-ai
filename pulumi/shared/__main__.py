...
class FlyApp(ComponentResource):
    ...
    def __init__(self, name: str, config: FlyAppConfig, opts: ResourceOptions | None = None):
...
class NeonDatabase(ComponentResource):
    ...
    def __init__(self, name: str, database_name: str, opts: ResourceOptions | None = None):
...
class RedisCache(ComponentResource):
    ...
    def __init__(self, name: str, memory_mb: int = 256, opts: ResourceOptions | None = None):
