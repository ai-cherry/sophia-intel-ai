...
class AgentBase(ABC):
    ...
    def __init__(self, name: str, domain: str = "artemis"):
        self.name = name
        self.domain = domain
...
class GrokAgent(AgentBase):
    ...
    def __init__(self):
        super().__init__("Grok", "artemis")
        # Note: API key should be in Artemis CLI environment
...
class ClaudeCoderAgent(AgentBase):
    ...
    def __init__(self):
        super().__init__("Claude Coder", "artemis")
        # Note: API key should be in Artemis CLI environment
