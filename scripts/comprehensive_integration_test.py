    ...
    async def test_agent_ui_integration(self):
        ...
        try:
            ...
            ui_env_path = os.path.join(
                os.path.dirname(__file__), "..", "sophia-intel-app", ".env.local"
            )
            if os.path.exists(ui_env_path):
                ...
                package_path = os.path.join(
                    os.path.dirname(__file__), "..", "sophia-intel-app", "package.json"
                )
                has_package = os.path.exists(package_path)
                # Check if Dockerfile exists
                dockerfile_path = os.path.join(
                    os.path.dirname(__file__), "..", "sophia-intel-app", "Dockerfile"
                )
