...
async def validate_consciousness_assumptions():
    ...
    try:
        ...
        with unittest.mock.patch(
            "app.swarms.unified_enhanced_orchestrator.SwarmMemoryClient",
            ...
            tracker_value_before = getattr(
                orchestrator, "global_consciousness_tracker", "NOT_SET"
            )
            print(
                f"   📊 global_consciousness_tracker before init: {has_tracker_before} (value: {tracker_value_before})"
            )
            ...
            tracker_value_after = getattr(
                orchestrator, "global_consciousness_tracker", "NOT_SET"
            )
            print(
                f"   📊 global_consciousness_tracker after init: {has_tracker_after} (value: {type(tracker_value_after) if tracker_value_after else 'None'})"
            )
            ...
            if tracker_value_after:
                ...
                is_consciousness_tracker = isinstance(
                    tracker_value_after, ConsciousnessTracker
                )
                print(
                    f"   📊 Is ConsciousnessTracker instance: {is_consciousness_tracker}"
                )
            print(
                "   ✅ UnifiedSwarmOrchestrator consciousness integration - LIKELY WORKING"
            )
    ...
    try:
        ...
        with unittest.mock.patch(
            "app.swarms.memory_integration.SwarmMemoryClient",
            return_value=mock_memory_client,
        ):
            ...
            print(
                f"   📊 consciousness_tracker before init: {has_tracker_before} (value: {tracker_value_before})"
            )
            ...
            print(
                f"   📊 consciousness_tracker after init: {has_tracker_after} (value: {type(tracker_value_after) if tracker_value_after else 'None'})"
            )
            # Check swarm type
            expected_swarm_type = "genesis_swarm"
            actual_swarm_type = (
                getattr(swarm.consciousness_tracker, "swarm_type", "NOT_SET")
                if tracker_value_after
                else "NO_TRACKER"
            )
            print(
                f"   📊 Swarm type check: expected='{expected_swarm_type}', actual='{actual_swarm_type}'"
            )
            if tracker_value_after and actual_swarm_type == expected_swarm_type:
                print(
                    "   ✅ MemoryEnhancedGenesisSwarm consciousness integration - LIKELY WORKING"
                )
            else:
                print(
        ...
        print(
            f"   ❌ MemoryEnhancedGenesisSwarm consciousness integration - ERROR: {e}"
        )
        print("   🚨 THIS IS LIKELY A FAILING TEST SOURCE")
    ...
    try:
        ...
        tracker_matches = (
            evolution_engine.consciousness_tracker is consciousness_tracker
        )
        print(f"   📊 Has consciousness_tracker: {has_consciousness_tracker}")
        print(f"   📊 Tracker matches: {tracker_matches}")
        # Check evolution stats
        expected_stats = [
            "consciousness_guided_evolutions",
            "consciousness_fitness_correlations",
            "consciousness_breakthroughs",
        ]
        stats_present = all(
            stat in evolution_engine.evolution_stats for stat in expected_stats
        )
        print(f"   📊 Consciousness stats present: {stats_present}")
        if has_consciousness_tracker and tracker_matches and stats_present:
            print(
                "   ✅ ExperimentalEvolutionEngine consciousness integration - LIKELY WORKING"
            )
        else:
            print(
                "   🚨 ExperimentalEvolutionEngine consciousness integration - POTENTIAL ISSUE"
            )
    except Exception as e:
        print(
            f"   ❌ ExperimentalEvolutionEngine consciousness integration - ERROR: {e}"
        )
        print("   🚨 THIS IS LIKELY A FAILING TEST SOURCE")
    print("\n" + "=" * 60)
