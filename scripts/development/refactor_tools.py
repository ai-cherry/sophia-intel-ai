...
Usage examples:
  ...
  python3 scripts/development/refactor_tools.py probe-import --module app..agent_factory
  python3 scripts/development/refactor_tools.py gen-proxy --old app//agent_factory.py --new app//factories/agent_factory.py --write
"""
