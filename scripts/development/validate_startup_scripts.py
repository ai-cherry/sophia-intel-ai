...
class StartupValidator:
    ...
    def validate_shell_scripts(self) -> Dict:
        ...
        for script in shell_scripts:
            ...
            commands = re.findall(
                r"\b(python|node|npm|docker|kubectl|vercel|pulumi|uv|redis-cli|psql|curl|git)\b",
                content,
            )
    ...
    def validate_devcontainer(self) -> Dict:
        ...
        try:
            ...
            results = {
                ...
                "extensions": config.get("customizations", {})
                .get("vscode", {})
                .get("extensions", []),
            ...
            if results["post_create_command"]:
                ...
                print("  ⚠️ No post-create command")
            return results
...
"""
        for script_path, results in self.results.get("shell_scripts", {}).items():
            ...
            if not results["has_error_handling"]:
                report += "  - ⚠️ No error handling\n"
            if results["hardcoded_paths"]:
                report += "  - ⚠️ Hardcoded paths found\n"
        report += """
## DevContainer
"""
