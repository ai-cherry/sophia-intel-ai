...
CLEANUP_SCRIPT="${SCRIPT_DIR}/cleanup_artemis_daily.sh"
CRON_SCHEDULE="0 3 * * *"  # Daily at 3 AM

echo "Setting up Artemis daily cleanup cron job..."
...
echo "To remove, run: crontab -l | grep -v cleanup_artemis_daily.sh | crontab -"
echo ""
