...
class IntegrationTester:
    ...
    async def run_all_tests(self) -> Dict:
        ...
        print(f"✅ {self.results['api_keys']['present_count']}/{self.results['api_keys']['total_count']} API keys present")
...
async def main():
    ...
    print(f"   - logs/integration_test_results.json")
    print(f"   - logs/integration_test_report.md")
