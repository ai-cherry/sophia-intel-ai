...
class GeminiDirectTest:
    def __init__(self):
        ...
        self.api_key = os.getenv("OPENROUTER_API_KEY", "")  # Route via OpenRouter
...
"""
    async def test_gemini_direct(self):
        """Test Gemini via OpenRouter API (no direct Google)."""
        print("\n" + "=" * 70)
        print("🚀 TESTING GEMINI 2.0 FLASH VIA OPENROUTER API")
        print("=" * 70)
        ...
        try:
            async with httpx.AsyncClient(timeout=60) as client:
                ...
                if response.status_code == 200:
                    ...
                    print("✅ SUCCESS: Gemini 2.0 Flash via OpenRouter API")
                    print(f"  Model: {model}")
