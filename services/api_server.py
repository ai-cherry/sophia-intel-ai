...
class OrchestrationRequest(BaseModel):
    request_type: str = Field(..., description="Type of request: code, chat, gpu, memory, health")
    payload: Dict[str, Any] = Field(..., description="Request payload")
    timeout: Optional[int] = Field(default=300, description="Request timeout in seconds")
