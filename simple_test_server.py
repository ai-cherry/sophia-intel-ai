...
# General chat endpoint for 
@app.post("/api/chat")
async def general_chat(request: ChatRequest):
    """Handle general chat messages (for  and other interfaces)"""
    message = request.message.lower()
    # -style responses (more direct and technical)
    if "swarm" in message or "agent" in message:
        ...
        response = "Hey there. I'm  - your slightly perfectionist AI companion with a penchant for getting things done right. What intellectual challenge can I demolish for you today?"
    else:
...
async def get_available_capabilities():
    ...
    try:
        ...
        capabilities_by_domain = {
            "": [
                {"name": cap.value, "description": " domain capability"}
                for cap in [
