...
// API Configuration
const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://104.171.202.107:30083'
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="chat" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>SOPHIA Chat Interface</CardTitle>
                <CardDescription>Interact with SOPHIA AI directly from the dashboard</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-gray-50 rounded-lg p-4 h-96 flex items-center justify-center">
                  <div className="text-center">
                    <MessageSquare className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-600 mb-4">Chat interface will be integrated here</p>
                    <Button onClick={() => window.open('http://104.171.202.107:30081', '_blank')}>
