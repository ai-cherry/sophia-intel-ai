...
export const MCPServerGrid: React.FC<MCPServerGridProps> = ({
  ...
  const getDomainTheme = (domain: string) => {
    switch (domain) {
      case 'sophia':
        return {
          title: 'SOPHIA TECHNICAL SERVERS',
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className={`text-2xl font-bold ${theme.text} ${domain === 'sophia' ? 'font-mono' : ''}`}>
                  {theme.title}
                </h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  disabled={isLoading}
                  className={domain === 'sophia' ? 'font-mono' : ''}
                >
        ...
        <div className="space-y-8">
          ...
          {exclusiveServers.length > 0 && (
            <div>
              {renderServerGrid(
                exclusiveServers,
                domain === 'sophia' ? 'TECHNICAL OPERATIONS' :
