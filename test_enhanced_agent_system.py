...
from app.swarms.agents.base_agent import AgentRole, BaseAgent
...
class AgentSystemTester:
    ...
    async def test_model_fallback_system(self):
        ...
        try:
            ...
            logger.info("   Primary model: GPT-5 via Portkey")
            logger.info("   Fallback model: Grok-4 via Portkey")
            logger.info("   Emergency fallback: OpenRouter direct")
