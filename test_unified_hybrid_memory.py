...
async def test_unified_hybrid_memory():
    ...
    try:
        ...
        # Test 3: Store Artemis development intelligence
        print("\n💻 Test 3: Storing Artemis development intelligence")
        artemis_session = await memory_system.store_episodic_memory(
        ...
        # Test 5: Cross-domain query (Gong + Artemis correlation)
        ...
        insight_id = await memory_system.store_business_insight(
            ...
            domains_involved=["artemis", "gong", "hubspot"],
