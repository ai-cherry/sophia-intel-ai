...
def create_artemis_mock_servers() -> Dict[str, MockMCPServer]:
    """Create mock servers for Artemis domain"""
    return {
        "filesystem": MockMCPServer(
            server_id="artemis_filesystem",
            server_type="FILESYSTEM",
            failure_rate=0.02,
            latency_range=(0.01, 0.05),
        ),
        "code_analysis": MockMCPServer(
            server_id="artemis_code_analysis",
            server_type="CODE_ANALYSIS",
            failure_rate=0.05,
            latency_range=(0.05, 0.2),
        ),
        "database": MockMCPServer(
            server_id="artemis_database",
