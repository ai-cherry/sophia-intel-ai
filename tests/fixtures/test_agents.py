"""
Test Agent Fixtures
Provides pre-configured test agents for both Artemis and Sophia domains
"""
...
def create_artemis_scout_agent() -> MockAgent:
    """Create a test Artemis scout agent"""
...
def create_artemis_engineer_agent() -> MockAgent:
    """Create a test Artemis engineer agent"""
    config = TestAgentConfig(
        name="Engineer-Test",
        domain="artemis",
...
def create_artemis_commander_agent() -> MockAgent:
    """Create a test Artemis commander agent"""
    config = TestAgentConfig(
        name="Commander-Test",
        domain="artemis",
...
def create_artemis_analyst_agent() -> MockAgent:
    """Create a test Artemis analyst agent"""
    config = TestAgentConfig(
        name="Analyst-Test",
        domain="artemis",
...
def create_artemis_test_swarm() -> List[MockAgent]:
    """Create a test Artemis military swarm"""
    return [
        create_artemis_commander_agent(),
        create_artemis_scout_agent(),
        create_artemis_engineer_agent(),
        create_artemis_analyst_agent(),
    ]
...
def create_test_agent(
    ...
    **kwargs,
    ...
    Args:
        name: Agent name
        domain: Agent domain (artemis/sophia)
