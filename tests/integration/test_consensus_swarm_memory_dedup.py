...
from app.swarms.patterns.consensus import ConsensusPattern, ConsensusConfig
...
async def run_integration_tests():
    ...
    try:
        ...
        from modern_embeddings import ModernEmbeddingConfig, IntelligentEmbeddingRouter, EmbeddingTier
