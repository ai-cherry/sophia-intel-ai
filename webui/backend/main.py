...
try:
    ...
    from app.orchestrator._supreme import SupremeOrchestrator
...
class WebUIServer:
    ...
    def __init__(self) -> None:
        ...
        self.mcp_urls = {
            ...
            "fs_": os.getenv(
                "MCP_FILESYSTEM__URL", "http://mcp-filesystem-:8000"
            ),
    ...
    def _routes(self) -> None:
        ...
        async def tools_invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
            ...
            Expected payload:
              {"capability":"fs|git|memory", "scope":"sophia|", "action":"list|read|write|...", "params":{...}}
            """
            ...
            if capability == "fs":
                base = self.mcp_urls["fs_sophia" if scope == "sophia" else "fs_"]
        ...
        async def approve_proposal(session_id: str, proposal_id: str) -> Dict[str, Any]:
            ...
            async with httpx.AsyncClient(timeout=60) as client:
                ...
                if prop.get("auto_commit") and prop.get("commit_message"):
                    repo = "sophia" if sess.repo_scope == "sophia" else ""
                    r = await client.post(
